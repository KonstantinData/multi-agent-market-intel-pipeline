...
def _build_sources(company_name: str, domain: str) -> List[Dict[str, str]]:
    ...
    external_urls = [
        ...
        (
            "Google News",
            f"https://news.google.com/search?q={company_query}%20industry%20trend",
        ),
        (
            "PR Newswire",
            f"https://www.prnewswire.com/search/news/?keyword={company_query}%20industry",
        ),
        (
            "Business Wire",
            f"https://www.businesswire.com/portal/site/home/search/?searchTerm={company_query}%20market",
        ),
