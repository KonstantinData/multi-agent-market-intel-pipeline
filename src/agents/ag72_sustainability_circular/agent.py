...
class AgentAG72SustainabilityCircular(BaseAgent):
    ...
    def run(self, case_input: Dict[str, Any]) -> AgentResult:
        ...
        output: Dict[str, Any] = {
            ...
            "findings": [
                {
                    "summary": "AG-72 sustainability and circular economy",
                    "notes": [
                        "collect sustainability initiatives and circularity signals",
                        "include certifications and targets with sources",
