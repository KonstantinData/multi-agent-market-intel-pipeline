...
def _build_sources(company_name: str, domain: str) -> List[Dict[str, str]]:
    ...
    external_urls = [
        ...
        ("PR Newswire", f"https://www.prnewswire.com/search/news/?keyword={company_query}%20pricing"),
        ("Business Wire", f"https://www.businesswire.com/portal/site/home/search/?searchTerm={company_query}%20pricing"),
