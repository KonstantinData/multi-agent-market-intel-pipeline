...
def create_repo_tree(repo_root: Path) -> None:
    ...
    src_files = [
        ...
        "src/agent_common/io_models.py",
        "src/agent_common/self_validation.py",
        "src/agent_common/evidence.py",
        "src/agent_common/source_capture.py",
        "src/agent_common/text_normalization.py",
        # registry
